...
import cz.lastaapps.president.widget.wrapper.WidgetsCombiner
...
internal class WidgetUpdateService : Service() {
    ...
    companion object {
        ...
        fun startService(context: Context) {
            ...
            if (!WidgetsCombiner.checkWidgetsPresented(context)) {
    ...
    private fun startJob() {
        ...
        if (!WidgetsCombiner.checkWidgetsPresented(this)) {
    ...
    private fun startUpdating() = scope.launch {
        ...
        CurrentState.getCurrentBuffered(scope).collect {
            ...
            WidgetsCombiner.updateAllWithState(context, it, themes.value)
            ...
            if (!WidgetsCombiner.checkWidgetsPresented(this@WidgetUpdateService)) {
                stopJob()
                stopSelf()
            }
